...
class FaceNavApp:
    ...
    def _build_ui(self):
        ...
        advisor_params = [
            ("EYE",   self.eye_thresh,   _eye_zone,   C["cyan"],   0.05, 0.40),
            ("SMILE", self.smile_thresh, _smile_zone, C["purple"], 0.02, 0.20),
            ("BROW",  self.brow_thresh,  _brow_zone,  C["yellow"], 0.02, 0.15),
            ("SPEED", self.sensitivity,  _sens_zone,  C["green"],  1.00, 8.00),
            ("SMOOTH",self.smoothing,    _smooth_zone,C["orange"], 0.05, 0.50),
        ]
        self._advisor_rows = []
        for param_label, param_var, param_zfn, param_color, lo, hi in advisor_params:
